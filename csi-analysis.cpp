...
// Global constants
const unsigned int cmfWidth = 150; // = 300 ns
const double cmfThreshold = 2.7; // ~ 3 * STD
...
int main(int argc, char* argv[])
{
	...
	case 1: BG_PT[0] = cmfWidth;
		...
		PE_max_PT = 100000;
		break;
	case 2: BG_PT[0] = cmfWidth;
		BG_PT[1] = 20000;
		BG_ROI[0] = 20000;
		BG_ROI[1] = 27400;
		S_PT[0] = 7400 + cmfWidth;
		S_PT[1] = 27400;
		S_ROI[0] = 27400;
		S_ROI[1] = 35000;
		PE_max_PT = 20;
		break;
	case 3: BG_PT[0] = cmfWidth;
		BG_PT[1] = 17500;
		BG_ROI[0] = 17500;
		BG_ROI[1] = 25000;
		S_PT[0] = 7500 + cmfWidth;
		S_PT[1] = 25000;
		S_ROI[0] = 25000;
		S_ROI[1] = 32500;
		PE_max_PT = 30;
