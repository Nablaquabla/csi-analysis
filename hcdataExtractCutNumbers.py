...
#    runDirs = ['Run-17-03-27-13-26-45','Run-17-04-05-18-47-04','Run-17-04-10-11-14-04',
#               'Run-17-04-17-16-14-23','Run-17-04-24-10-13-09','Run-17-05-01-09-57-15',
#               'Run-17-05-08-09-34-23','Run-17-05-09-14-09-13','Run-17-05-15-11-54-49']
...
#    runDirs = [x for x in os.listdir(mainDir) if 'Run' in x]
    for run in runDirs:
        cmd = 'qsub -V /nfs_home/bjo/GitHub/csi-analysis/_qsubExtractCutNumbers.sh -v mainDir="%s",run="%s",excludeTimeFile="%s"'%(mainDir,run,excludeTimeFile)
        os.system(cmd)
        tm.sleep(1)
